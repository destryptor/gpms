...
from src.routes import register_routes, agricult_routes, panchayat_routes, citizen_routes, panchayat_member_routes,family_member_routes,scheme_routes,asset_routes, user_routes
